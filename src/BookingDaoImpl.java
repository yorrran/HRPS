...
public class BookingDaoImpl implements BookingDao
{
    ...
    public void displayBooking()
    {
        ...
        for (int i = 0; i < bookingList.size(); i++)
        {
            ...
            System.out.println("Room number: " + room.getRoomNumber() + ", Price: " + price +
                    ", Check In Date: " + dateFormat.format(checkInDatetime) +
                    ", Check Out Date: " + dateFormat.format(checkOutDatetime));
